...
export function RequestError({ onRetry, onBackToHome }: RequestErrorProps) {
  return (
      ...
      <div className="px-5 w-full max-w-[375px] relative">
        ...
        >
          ...
          >
            ...
            {/* Main icon container */}
            <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-[rgba(211,47,47,0.2)] to-[rgba(142,142,147,0.15)] border-2 border-[rgba(211,47,47,0.3)] flex items-center justify-center">
              {/* Alert Icon */}
              <motion.div
                animate={{
                  rotate: [0, -5, 5, -5, 0],
          ...
          >
            <p className="text-white text-sm font-medium mb-3">Possible Reasons:</p>
          ...
          >
            ...
            />
            <span className="text-[rgba(203,251,241,0.5)] text-sm">Unable to connect</span>
          </motion.div>

          {/* Retry Button */}
          <motion.button
            onClick={onRetry}
            className="w-full h-14 bg-gradient-to-r from-[#00d5be] to-[#00bba7] rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-[rgba(0,213,190,0.2)] relative overflow-hidden mb-3"
          ...
          {onBackToHome && (
            <motion.button
              ...
              className="w-full h-12 text-[rgba(203,251,241,0.6)] text-sm font-medium"
              whileHover={{ color: "rgba(203,251,241,0.8)" }}
              whileTap={{ scale: 0.98 }}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
