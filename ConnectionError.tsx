        ...
        >
          ...
          >
            ...
            <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-[rgba(211,47,47,0.2)] to-[rgba(142,142,147,0.15)] border border-[rgba(211,47,47,0.3)] flex items-center justify-center">
              ...
              >
                <WifiOff className="w-12 h-12 text-[#d32f2f]" />
              </motion.div>
            </div>

            {/* Alert badge */}
            <motion.div
              className="absolute -bottom-1 -right-1 w-8 h-8 bg-[rgba(211,47,47,0.2)] border-2 border-[#d32f2f] rounded-full flex items-center justify-center"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
          ...
          >
            <p className="text-white text-sm font-medium mb-3">Troubleshooting Tips:</p>
            
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-[#00d5be] mt-1.5 flex-shrink-0" />
                <p className="text-[rgba(203,251,241,0.6)] text-sm">
                  Check if your mobile data or Wi-Fi is turned on
                </p>
              </div>
              ...
              <div className="flex items-start gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-[#00d5be] mt-1.5 flex-shrink-0" />
                <p className="text-[rgba(203,251,241,0.6)] text-sm">
                  Make sure you're in an area with good signal
                </p>
              </div>
          ...
          >
            ...
            />
            <span className="text-[rgba(203,251,241,0.5)] text-sm">Offline</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-white text-base font-semibold relative">Retry Connection</span>
          </motion.button>
        </motion.div>
      </div>
    </div>
